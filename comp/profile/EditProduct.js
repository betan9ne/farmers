...
const EditProduct =({route})=> {
    ...
    return (
      ...
      <View style={{backgroundColor:COLORS.white, padding:SIZES.padding*2}}>
            <Text style={{...FONTS.h5}}>Update the price and stock of your item below.</Text>
            
            <View style={{}}>
                  <Text style={{...FONTS.h5, marginTop:20, color:COLORS.black}}>Price</Text>
                <TextInput keyboardType="number-pad"  placeholder="How much does it cost" defaultValue={data.price} onChangeText={(value)=>setPrice(value)} style={{padding: SIZES.padding*2, borderWidth:0.4, borderRadius:10}} />
                <Text style={{...FONTS.h5, marginTop:10}}>Items Available</Text>
                <TextInput keyboardType="number-pad" placeholder="What do you have available" defaultValue={data.items} onChangeText={(value)=>setItems(value)} style={{padding: SIZES.padding*2, borderWidth:0.4, borderRadius:10}} />
            ...
            <TouchableOpacity onPress={() => updateProduce()} style={{backgroundColor:COLORS.black, marginTop:40, borderRadius:10, paddingHorizontal:30, paddingVertical:20}}>
                    <Text style={{color:COLORS.white, textAlign:"right", ...FONTS.h4}}>Update Product</Text>
                </TouchableOpacity>         
        </View>
